      ...
      <div className="relative w-full h-full flex flex-col justify-between">
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between pt-28 sm:pt-32 lg:pt-36 pb-12 sm:pb-16 lg:pb-20 px-6 sm:px-12 lg:px-20 text-gray-900">
          ...
          <div className="max-w-xl md:my-auto space-y-4 pt-12 md:pt-0">
            ...
            <p className="text-gray-600 text-xs sm:text-sm md:text-base leading-relaxed font-sans font-light">
              {img.details}
            </p>
          </div>
...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="pt-24 pb-0 bg-[#FAF9F6] border-b border-gray-200 relative overflow-visible">
